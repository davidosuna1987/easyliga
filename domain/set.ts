...
export const SET_POINTS_TO_WIN = 25 // production
// export const SET_POINTS_TO_WIN = 5 // development
export const LAST_SET_POINTS_TO_WIN = 15 // production
// export const LAST_SET_POINTS_TO_WIN = 3 // development
